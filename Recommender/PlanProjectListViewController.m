//
//  PlanProjectListViewController.m
//  Recommender
//
...
#import "PlanProjectListViewController.h"
#import "PlanPlanListViewController.h"

@interface PlanProjectListViewController ()

@end

@implementation PlanProjectListViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue.identifier isEqualToString:@"ToPlanPlanListView"]) {
        PlanPlanListViewController *pVC = segue.destinationViewController;
        pVC.poi = self.poi;
